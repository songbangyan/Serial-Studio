...
"""
    ...
    # Equivalent CSV parser written in Lua. Mirrors comma_separated.lua.
    # Used to validate that the same scenarios work under the Lua engine.
    CSV_PARSER_TEMPLATE_LUA = """--
-- Comma-Separated Values (CSV) Parser
--
-- Parses comma-separated data into an array of values.
--
