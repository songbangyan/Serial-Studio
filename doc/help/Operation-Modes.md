...
Pick the "Parse via Project File" radio button in the Setup panel. Then load or create a project file in the Project Editor (the **Project Editor** button in the toolbar).
