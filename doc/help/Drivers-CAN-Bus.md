...
- **Multiplexed (MUX) signals do not decode.** The auto-generated parser does not handle DBC multiplexing. If a single message ID carries different payloads gated by a mux byte, edit the generated Lua to add the mux check or write a custom parser.
