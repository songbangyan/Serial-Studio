...
If your device speaks "classic" Bluetooth (the older 2.x flavor with SPP — Serial Port Profile), the OS exposes it as a virtual COM port and you should use the [UART driver](Drivers-UART.md) instead. This page is for BLE specifically.
