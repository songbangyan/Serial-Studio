...
Widgets.Pane {
  ...
  property int folderId: Cpp_JSON_ProjectEditor.selectedGroupFolderId
  property string folderName: Cpp_JSON_ProjectModel.groupFolderTitle(folderId)
  ...
  Page {
    ...
    ColumnLayout {
      ...
      //
      // Secondary toolbar: Add Sub-folder, Add Group, Rename, Delete
      //
      Rectangle {
        id: toolbar
      ...
      //
      // Header + contents list (folders + groups inside this folder)
      //
      ...
      ListView {
        ...
        Label {
          ...
          text: qsTr("This folder is empty. Use the toolbar to add a group or sub-folder.")
        }
      }
    }
  }
