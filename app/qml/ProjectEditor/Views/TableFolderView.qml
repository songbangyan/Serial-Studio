...
Widgets.Pane {
  ...
  property int folderId: Cpp_JSON_ProjectEditor.selectedTableFolderId
  property string folderName: Cpp_JSON_ProjectModel.tableFolderTitle(folderId)
  ...
  function refresh() {
    folderName = Cpp_JSON_ProjectModel.tableFolderTitle(folderId)
    contents = Cpp_JSON_ProjectEditor.tableFolderContents(folderId)
  }
  ...
  Page {
    ...
    ColumnLayout {
      ...
      //
      // Secondary toolbar: Add Sub-folder, Add Shared Table, Rename, Delete
      //
      Rectangle {
        id: toolbar
        ...
        RowLayout {
          ...
          Widgets.ToolbarButton {
            ...
            onClicked: Cpp_JSON_ProjectModel.promptAddTableFolder(root.folderId)
          ...
          Widgets.ToolbarButton {
            ...
            Layout.alignment: Qt.AlignVCenter
            ToolTip.text: qsTr("Add a shared table inside this folder")
            onClicked: Cpp_JSON_ProjectModel.promptAddTableInFolder(root.folderId)
          ...
          Widgets.ToolbarButton {
            ...
            onClicked: Cpp_JSON_ProjectModel.promptRenameTableFolder(root.folderId)
          ...
          Widgets.ToolbarButton {
            ...
            onClicked: Cpp_JSON_ProjectModel.confirmDeleteTableFolder(root.folderId)
      ...
      //
      // Header + contents list (folders + tables inside this folder)
      //
      ...
      ListView {
        ...
        Label {
          ...
          text: qsTr("This folder is empty. Use the toolbar to add a table or sub-folder.")
        }
      }
    }
  }
