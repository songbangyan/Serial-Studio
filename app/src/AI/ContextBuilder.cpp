...
QString AI::ContextBuilder::roleBlock()
{
  return QStringLiteral(
    ...
    "JavaScript-ONLY; the Lua nudge does NOT apply to them. ALWAYS pass "
    "`language` on setCode/setTransformCode -- a mismatch is a silent "
    "compile failure.\n"
    ...
    "ends up empty. Prefer virtual datasets over baking derivations "
    "into the parser -- they're testable via dryRun, can read peers "
    "across sources, and carry their own units/ranges/alarms.\n"
