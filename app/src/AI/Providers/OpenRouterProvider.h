...
/**
 * @brief OpenRouter adapter on top of the OpenAI-compatible Chat Completions transport.
 */
class OpenRouterProvider : public Provider {
public:
  OpenRouterProvider(QNetworkAccessManager& nam, std::function<QString()> keyGetter);
